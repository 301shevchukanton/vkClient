...
public class WallPostActivity extends Activity {
        ...
        currentRequest.executeWithListener(new VKRequest.VKRequestListener() {
            ...
            private void setUserInfo(VKResponse response) {
                try {
                    ...
                    try {
                        new DownloadImageTask((ImageView) findViewById(R.id.post_photo)).execute(r.getString("photo_200"));
                    } catch (Exception e) {
                    }
                    ;
    ...
    private void post(){
     ...
     //   currentRequest = VKApi.wall().post(VKParameters.from(VKApiConst.USER_ID,profileId,VKApiConst.MESSAGE, msg));
