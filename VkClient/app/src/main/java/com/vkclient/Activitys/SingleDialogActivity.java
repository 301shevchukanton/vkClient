...
import com.vkclient.Adapters.SingleDialogListViewAdapter;
        ...
        currentRequest.executeWithListener(new VKRequest.VKRequestListener() {
            ...
            public void onComplete(final VKResponse response) {
                ...
                try {
                    ...
                    myrequest = myRequests.getUserById(messagesArray.getJSONObject(i).getString("user_id"));
                        if(Integer.parseInt(messagesArray.getJSONObject(i).getString("user_id"))!=
                                Integer.parseInt(messagesArray.getJSONObject(i).getString("from_id")))
                    fromrequest = myRequests.getUserById(messagesArray.getJSONObject(i).getString("from_id"));
                    }
                    if (myrequest != null) {
